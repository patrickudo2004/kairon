...
const AnalyticsDashboard: React.FC<AnalyticsDashboardProps> = ({ program, onUpdateSlot }) => {
    ...
    return (
        <div id="printable-area" className="max-w-6xl print:max-w-none mx-auto p-6 space-y-8 print:space-y-4 animate-in fade-in duration-500">
            ...
            {/* Footer Insight */}
            <div className="bg-[#121418] border border-[#22262E] rounded-2xl p-6 md:p-8 print:p-4 text-white flex flex-col md:flex-row print:flex-row items-center justify-between gap-6 print:gap-4 shadow-xl font-sans">
                <div className="print:flex-1">
                    <h3 className="text-xl font-bold font-mono uppercase tracking-wider mb-2 text-[#0EA5E9]">Production Insight</h3>
                    <p className="max-w-xl text-[#8A93A4] text-sm font-medium leading-relaxed">
                ...
                <div className="p-4 bg-[#181B22] rounded-xl border border-[#22262E] font-mono text-center md:text-right">
                    <div className="text-[10px] font-bold uppercase tracking-widest text-slate-500 mb-1">Generated by</div>
